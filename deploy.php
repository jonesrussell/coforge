...
task('deploy:restart_services', function (): void {
    ...
    run('systemctl --user restart coforge-schedule-work.service coforge-horizon.service coforge-inertia-ssr.service coforge-articles-subscribe.service', ['allow_failure' => true]);
});
